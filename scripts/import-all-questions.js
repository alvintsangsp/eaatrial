...
console.log('Starting to import all 935 questions...');
...
export const questions: Question[] = [\n`;
  ...
  console.log(`\n✅ Success!`);
  console.log(`📊 Generated ALL ${questionCount} questions`);
  console.log(`📝 Output file: ${outputPath}`);
  console.log(`\n🎉 All ${questionCount} questions have been imported successfully!`);
